**STATUS: D01-D26 RATIFIED BY SAM (2026-08-03) — CLOSED FOR AUTONOMOUS BUILD EXECUTION.** Provenance: D01-D18 drafted by Claude, approved by Sam in chat. D19 drafted by Claude from Sam's palette screenshots. D20-D25 drafted by Codex to close autonomy gaps per Sam's no-hand-holding instruction; factual claims (MathLive version, reference-repo SHAs) independently verified by Claude against npm and cloned repo states. D26 drafted by Codex after Sam clarified that in-document editing is the core requirement. Sam reviewed the full set and ratified all 26 in the Claude session on 2026-08-03. These are closed. No builder — human or AI — may reopen them without a new decision note in this folder. The specs cite them as (Dxx).
